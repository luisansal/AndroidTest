...
class MapsFragment : Fragment(), OnMapReadyCallback, TitleListener, GoogleMap.OnMapClickListener {
    ...
    var btnMostrarVisitas: Button? = null

    var acBuscarLugares: AutoCompleteTextView? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnMostrarVisitas = view.findViewById(R.id.btnMostrarVisitas) as Button
        acBuscarLugares = view.findViewById(R.id.acBuscarLugares) as AutoCompleteTextView
